...
const SignUp = ({ open, handleClose, handleOpenSignIn }) => {
  ...
  const handleSignUp = async () => {
    ...
    try {
      // Fix month index (frontend uses 1-12, Date constructor expects 0-11)
          ...
          >
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
              <TextField
                ...
                variant="outlined"
                value={firstName}
                onChange={(e) => setFirstName(sanitize.name(e.target.value))}
                sx={{ mb: 0.5 }}
              />
              ...
              <TextField
                ...
                variant="outlined"
                value={middleName}
                onChange={(e) => setMiddleName(sanitize.name(e.target.value))}
                sx={{ mb: 0.5 }}
              />
              ...
              <TextField
                ...
                variant="outlined"
                value={lastName}
                onChange={(e) => setLastName(sanitize.name(e.target.value))}
                sx={{ mb: 0.5 }}
              />
